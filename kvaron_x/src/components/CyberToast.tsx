  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col gap-1 pr-4">
        ...
        <p className="text-xs font-medium text-cyber-text-muted leading-relaxed select-text font-sans">
          {toast.message}
        </p>
      </div>
      ...
      <button
        onClick={onClose}
        className="flex-shrink-0 h-fit p-1 text-white/40 hover:text-white transition-colors duration-150 rounded"
      >
        <X className="w-4 h-4" />
      </button>
